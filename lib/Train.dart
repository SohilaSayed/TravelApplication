...
class _TrainState extends State<Train> {
  ...
  final Classes=["Cairo" ,"Alexandria" , "Luxor" , "Matruh","Sharm ElSheikh", "Dahab" ,"Suez" ,"Port Said" , "Aswan" , "Assuit","Hurghada", "Tanta" ];
  final items=["Cairo" ,"Alexandria" , "Luxor" , "Matruh","Sharm ElSheikh", "Dahab","Suez" ,"Port Said" , "Aswan" , "Assuit","Hurghada", "Tanta" ];
  String? Deptvalue;
  String?DestValue;
  String? Class;
  //String valueChoose;
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(length:2,
        child:Scaffold(
          appBar: AppBar(
            title: Text("Train Booking",style: TextStyle(fontSize: 30,color: Colors.white),),
            centerTitle: true,
